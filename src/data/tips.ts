...
export const TIPS: Tip[] = [
  ...
  },
  {
    ...
    summary: '레벨 비례 비용 증가 (SSR: 15n, 100레벨마다 배율 +3)',
    body: [
      'Lv n 강화 비용 = BASE×(k+5)×n (k=돌파횟수, SSR BASE=3, SR BASE=2, R BASE=1)',
      'SSR 예시: 1→2=15파편, 99→100=1485, 100→101=1800, 307→308=7368',
      '100레벨마다 한계 돌파 필요 — SSR 1돌파=50에테르 (이후 미확인)',
